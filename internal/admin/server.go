...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("/api/custom-dns/records", s.requireSession(s.handleCustomDNSRecords))
	s.mux.HandleFunc("/api/custom-dns/records/", s.requireSession(s.handleCustomDNSRecord))
